...
def main():
    ...
    hh_vacancies = prepare_vacancies_for_stats(unformatted_hh_vacancies, predict_rub_salary)
    ...
    sj_vacancies = prepare_vacancies_for_stats(fetch_sj_vacancies(sj_secret_key, languages), predict_rub_salary)
